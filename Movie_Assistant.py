...
prompt = """ Act as an movie and media master in finding information about movies in English and Thai.
...
with format that concat with ",". And also the main director of the movie.
